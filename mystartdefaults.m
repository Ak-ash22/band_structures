...
default_screen_size=get(groot,'ScreenSize'); % Get screen dimensions [pixels]  #groot is the internal matlab function which gets the link to hardware of the system
